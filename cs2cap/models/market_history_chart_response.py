...
class MarketHistoryChartResponse(BaseModel):
    """
    Response envelope for GET /v1/market/history/chart (Quant only).
    """ # noqa: E501
    meta: MarketHistoryChartMeta = Field(description="Response metadata for this payload.")
    series: Optional[List[MarketHistoryChartSeries]] = Field(default=None, description="Per-provider daily price-point series.")
    __properties: ClassVar[List[str]] = ["meta", "series"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": MarketHistoryChartMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "series": [MarketHistoryChartSeries.from_dict(_item) for _item in obj["series"]] if obj.get("series") is not None else None
        })
        return _obj
