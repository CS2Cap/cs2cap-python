...
class MarketHistoryChartSeries(BaseModel):
    """
    Per-provider daily price-point series.
    """ # noqa: E501
    provider: StrictStr = Field(description="Provider key.")
    data: Optional[List[MarketHistoryChartPoint]] = Field(default=None, description="Daily points ordered by ascending bucket.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [MarketHistoryChartPoint.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
