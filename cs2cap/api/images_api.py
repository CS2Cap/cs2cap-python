...
class ImagesApi:
    ...
    def list_game_images(
        self,
        format: Annotated[Optional[StrictStr], Field(description="Image URL format. Defaults to png; webp rewrites .png URL suffixes.")] = None,
        ...
        :param format: Image URL format. Defaults to png; webp rewrites .png URL suffixes.
        :type format: str
