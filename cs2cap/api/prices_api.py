...
class PricesApi:
    ...
    def get_price_candles(
        ...
        _param = self._get_price_candles_serialize(
            item_id=item_id,
    ...
    @validate_call
    def get_price_candles_with_http_info(
        self,
        item_id: Annotated[Optional[StrictInt], Field(description="Filter by item ID")] = None,
        market_hash_name: Annotated[Optional[StrictStr], Field(description="Filter by market hash name")] = None,
        phase: Annotated[Optional[Any], Field(description="Filter by phase (e.g., Phase 1, Ruby, Sapphire)")] = None,
    ...
    @validate_call
    def get_price_candles_without_preload_content(
        self,
        item_id: Annotated[Optional[StrictInt], Field(description="Filter by item ID")] = None,
        market_hash_name: Annotated[Optional[StrictStr], Field(description="Filter by market hash name")] = None,
        phase: Annotated[Optional[Any], Field(description="Filter by phase (e.g., Phase 1, Ruby, Sapphire)")] = None,
    ...
    def _get_price_candles_serialize(
        self,
        item_id,
        market_hash_name,
        phase,
