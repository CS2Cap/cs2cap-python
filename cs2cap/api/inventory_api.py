...
class InventoryApi:
    ...
    def get_steam_inventory(
        ...
        _param = self._get_steam_inventory_serialize(
    ...
    @validate_call
    def get_steam_inventory_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_steam_inventory_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_steam_inventory_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def get_steam_inventory_by_steam_id(
        self,
        ...
        _param = self._get_steam_inventory_by_steam_id_serialize(
            steam_id=steam_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_steam_inventory_by_steam_id_with_http_info(
        self,
        steam_id: Annotated[StrictStr, Field(description="Steam64ID (17-digit) or vanity URL name (e.g. 'dadscap').")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_steam_inventory_by_steam_id_without_preload_content(
        self,
        steam_id: Annotated[StrictStr, Field(description="Steam64ID (17-digit) or vanity URL name (e.g. 'dadscap').")],
        _request_timeout: Union[
            None,
    ...
    def _get_steam_inventory_by_steam_id_serialize(
        self,
        steam_id,
        _request_auth,
        _content_type,
