...
class PortfolioApi:
    ...
    def get_portfolio_value(
        ...
        _param = self._get_portfolio_value_serialize(
            portfolio_id=portfolio_id,
            currency=currency,
            providers=providers,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_portfolio_value_with_http_info(
        self,
        portfolio_id: UUID,
        currency: Annotated[Optional[StrictStr], Field(description="Target currency code.")] = None,
        providers: Annotated[Optional[List[StrictStr]], Field(description="Provider keys to include. Repeat to pass multiple, e.g. providers=steam&providers=skinport. Omit for all providers.")] = None,
    ...
    @validate_call
    def get_portfolio_value_without_preload_content(
        self,
        portfolio_id: UUID,
        currency: Annotated[Optional[StrictStr], Field(description="Target currency code.")] = None,
        providers: Annotated[Optional[List[StrictStr]], Field(description="Provider keys to include. Repeat to pass multiple, e.g. providers=steam&providers=skinport. Omit for all providers.")] = None,
    ...
    def _get_portfolio_value_serialize(
        self,
        portfolio_id,
        currency,
        providers,
    ...
    def get_portfolio_value_history(
        ...
        _param = self._get_portfolio_value_history_serialize(
            portfolio_id=portfolio_id,
    ...
    @validate_call
    def get_portfolio_value_history_with_http_info(
        self,
        portfolio_id: UUID,
        start_date: Annotated[Optional[date], Field(description="Inclusive UTC start date (YYYY-MM-DD).")] = None,
        end_date: Annotated[Optional[date], Field(description="Inclusive UTC end date (YYYY-MM-DD). Defaults to today.")] = None,
    ...
    @validate_call
    def get_portfolio_value_history_without_preload_content(
        self,
        portfolio_id: UUID,
        start_date: Annotated[Optional[date], Field(description="Inclusive UTC start date (YYYY-MM-DD).")] = None,
        end_date: Annotated[Optional[date], Field(description="Inclusive UTC end date (YYYY-MM-DD). Defaults to today.")] = None,
    ...
    def _get_portfolio_value_history_serialize(
        self,
        portfolio_id,
        start_date,
        end_date,
    ...
    def value_portfolio(
        ...
        _param = self._value_portfolio_serialize(
    ...
    @validate_call
    def value_portfolio_with_http_info(
        self,
        portfolio_request: PortfolioRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def value_portfolio_without_preload_content(
        self,
        portfolio_request: PortfolioRequest,
        _request_timeout: Union[
            None,
    ...
    def _value_portfolio_serialize(
        self,
        portfolio_request,
        _request_auth,
        _content_type,
